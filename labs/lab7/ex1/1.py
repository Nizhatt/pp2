...
# Load images
icon = pygame.image.load('labs/lab7/ex1/image/clock.svg') # logo
pygame.display.set_icon(icon)

bg = pygame.image.load('labs/lab7/ex1/image/clock.png') # Background
min_img = pygame.image.load('labs/lab7/ex1/image/min_hand .png') # Left hand
sec_img = pygame.image.load('labs/lab7/ex1/image/sec_hand.png') # Right hand
